<template>
    <div>
        ...
        <iv-visualisation>
            ...
            positonModal is used to position the modal on the screen <redText>[need clarification (from Dan..) on how this works]</redText>.
            ...
            <p><redText>Need a section of using the button</redText>
            </p>
        </iv-visualisation>
    </div>
</template>
